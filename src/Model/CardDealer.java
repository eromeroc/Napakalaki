...
public class CardDealer {
    ...
    private void initMonsterCardDeck(){
        ...
        BadConsequence badConsequence = new BadConsequenceTypeTreasures("Pierdes tu armadura visible y otra oculta", 0,      
        ...
        badConsequence = new BadConsequenceTypeTreasures("Embobados con el lindo primigenio te descartas de tu casco visible",
        ...
        badConsequence = new BadConsequenceTypeTreasures("El primordial bostezo contagioso. Pierdes el calzado visible.",
        ...
        badConsequence = new BadConsequenceTypeTreasures("Te atrapan para llevarte de fiesta y te dejan caer en mitad del vuelo. Descarta 1 mano visible "
        ...
        unusedMonsters.add(new Monster("El gorrón en el umbral",10, badConsequence, prize));
         ...
         badConsequence = new BadConsequenceTypeTreasures("Pierdes la armadura visible", 0,
                 new ArrayList(Arrays.asList(TreasureKind.ARMOR)), new ArrayList());
        prize = new Prize(2,1);
        unusedMonsters.add(new Monster("H.P. Munchcraft", 6, badConsequence, prize));
    
        //Crea monstruo "Bichgooth"
        badConsequence = new BadConsequenceTypeTreasures("Sientes bichos bajo la ropa. Descarta la armadura visible", 0, 
        new ArrayList(Arrays.asList(TreasureKind.ARMOR)), new ArrayList());
        prize = new Prize(1,1);
        unusedMonsters.add(new Monster("Bichgooth",2, badConsequence,prize));
    
        //Crea monstruo "El rey de la rosa"
        badConsequence = new BadConsequenceNumTreasures("Pierdes 5 niveles y 3 tesoros visibles", 5, 3, 0);
        prize = new Prize(4,2);
        unusedMonsters.add(new Monster("El rey de rosa", 13, badConsequence, prize));
    
        //Crea monstruo "La que redacta en las tinieblas"
        badConsequence = new BadConsequenceNumTreasures("Toses los pulmones y pierdes dos niveles", 2, 0, 0);
        prize = new Prize(1,1);
        unusedMonsters.add(new Monster("La que redacta en las tinieblas",2, badConsequence, prize));
    
        //Crea monstruo "Los hondos"
        badConsequence = new BadConsequenceDeath("Estos unusedMonsters resultan bastante superficiales"
                + " y te aburren mortalmente");
        prize = new Prize(2,1);
        unusedMonsters.add(new Monster("Los hondos",8, badConsequence, prize));
    
        //Crea monstruo "Semillas Cthulhu"
        badConsequence = new BadConsequenceNumTreasures("Pierdes 2 niveles y 2 tesoros ocultos", 2, 0, 2);
        prize = new Prize(2,1);
        unusedMonsters.add(new Monster("Semillas Cthulhu", 4, badConsequence, prize));
    
        //Crea monstruo "Dameargo"
        badConsequence = new BadConsequenceTypeTreasures("Te intentas escaquear. Pierdes una mano visible", 0, 
        ...
        badConsequence = new BadConsequenceNumTreasures("Da mucho asquito. Pierdes 3 niveles", 3, 0, 0);
        prize = new Prize(1,1);
        unusedMonsters.add(new Monster("Pollipólipo volante", 3, badConsequence, prize));
    
        //Crea monstruo "Yskhtihyssg-Goth"
        badConsequence = new BadConsequenceDeath("No le hace gracia que pronuncien mal su nombre."
                + "Estas muerto");
        prize = new Prize(3,1);
        unusedMonsters.add(new Monster("Yskhtihyssg-Goth", 12, badConsequence, prize));
    
        //Crea monstruo "Familia feliz"
        badConsequence = new BadConsequenceDeath("La familia te atrapa. Estas muerto");
        prize = new Prize(4,1);
        unusedMonsters.add(new Monster("Familia feliz", 1, badConsequence, prize));
    
        //Crea monstruo "Roboggoth"
        badConsequence = new BadConsequenceTypeTreasures("La quinta directiva primaria te obliga a perder 2 niveles"
        ...
        badConsequence = new BadConsequenceTypeTreasures("Te asusta en la noche. Pierdes un casco visible", 0, 
        new ArrayList(Arrays.asList(TreasureKind.HELMET)), new ArrayList());
        prize = new Prize(1,1);
        unusedMonsters.add(new Monster("El espia", 5, badConsequence, prize));
    
        //Crea monstruo "El Lenguas"
        badConsequence = new BadConsequenceNumTreasures("Menudo susto te llevas. Pierdes 2 niveles y"
                + " 5 tesoros visibles", 2, 5, 0);
        prize = new Prize(1,1);
        unusedMonsters.add(new Monster("El Lenguas" , 20, badConsequence, prize));
    
        //Crea monstruo "Bicéfalo"
        badConsequence = new BadConsequenceTypeTreasures("Te faltan manos para tanta cabeza. Pierdes 3 niveles "
